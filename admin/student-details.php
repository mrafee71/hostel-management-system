		...
		<div class="content-wrapper">
			<div class="container-fluid">
				<div class="row" id="print">
					...
					<div class="col-md-12">
						<h2 class="page-title" style="margin-top:6%">Rooms Details</h2>
						<div class="panel panel-default">
							<div class="panel-heading">All Room Details<?php	
...
<?php	
$aid=$_GET['regno'];
	$ret="select * from booking where (regno	=?)";
echo $aid;
...
<tr>
<td colspan="6" style="text-align:center; color:red"><h3>Room Related Info</h3></td>
</tr>
<tr>
...
<tr>
<td colspan="6" style="text-align:center; color:red"><h4>Addresses</h4></td>
</tr>
<tr>
