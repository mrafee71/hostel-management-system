...
$aid=$_SESSION['id'];
$udate=date('Y-m-d');
$query="update hostelmanager set email=?,updation_date=? where id=?";
...
<head>
	...
	<title>Hostel Manager Profile</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Hostel Manager Profile</h2>
	<?php	
$aid=$_SESSION['id'];
	$ret="select * from hostelmanager where id=?";
						...
						<div class="row">
							<div class="col-md-6">
								<div class="panel panel-default">
									<div class="panel-heading">Hostel Manager profile details</div>
